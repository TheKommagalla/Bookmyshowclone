                ...
                <div className="Latest-Filter">
                 ...
                 <p className="recommended-heading text-dark ">Filters</p>
                   <select  className="form-select  mx- auto my-4 " aria-label="Default select example">
                    ...
                    <option value="Action">Telugu</option>
                    <option value="Drama">Hindi</option>
                    <option value="Comedy">English</option>
                    <option value="Horror">Marti</option>
                    <option value="Romance">kanada</option>
                    
                   </select>
                   <select  className="form-select mx- auto my-4" aria-label="Default select example">
                    {/* <option    selected hidden>Language</option> */}
                    <option value="" hidden >Genres </option>
                    <option value="telugu">Comedy</option>
                   ...
                   <select  className="form-select mx- auto my-4" aria-label="Default select example">
                    ...
                    <option value="Action">2D</option>
                    <option value="Drama">3D</option>
                    <option value="Comedy">4DX</option>
                    <option value="Horror">IMX</option>
